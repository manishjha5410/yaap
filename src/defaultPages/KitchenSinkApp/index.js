    ...
    return (
      <React.Fragment>
        ...
        <div css={wrapperStyle()}>
          ...
          {loader}
          {errorMessage}
          <span><img alt="khulke" src="https://www.khulke.com/static/media/KhulKe_logo.b9b0e8fd.svg" height="100px" width="100px" /></span>

          {/* <p css={titleStyle()}>Khulke App Chat Login</p> */}
          ...
          <div css={uidWrapperStyle()}>
            ...
            <div style={{ "display": "flex", "alignItems": "center" }}>
              ...
              {/* <div css={loginBtn()}><button type="button" onClick={() => this.login()}>Signup</button></div> */}
            </div>
          </div>
        </div>
      </React.Fragment>
